            ...
            <div class="card m-b-30">
                ...
                <div class="card-body pb-1">
                    <div class="ecommerce-upload">
                        ...
                        <img src="assets/backend/images/dashboard/cloud.svg" class="img-fluid" alt="cloud">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">#1</th>
                                    <td><img src="assets/backend/images/users/men.svg" class="img-fluid" width="35" alt="customer"></td>
                                ...
                                <tr>
                                    <th scope="row">#2</th>
                                    <td><img src="assets/backend/images/users/women.svg" class="img-fluid" width="35" alt="customer"></td>
                                ...
                                <tr>
                                    <th scope="row">#3</th>
                                    <td><img src="assets/backend/images/users/boy.svg" class="img-fluid" width="35" alt="customer"></td>
                                ...
                                <tr>
                                    <th scope="row">#4</th>
                                    <td><img src="assets/backend/images/users/girl.svg" class="img-fluid" width="35" alt="customer"></td>
                                ...
                                <tr>
                                    <th scope="row">#7</th>
                                    <td><img src="assets/backend/images/users/boy.svg" class="img-fluid" width="35" alt="men"></td>
                                    <td>John Terry</td>
                                    <td>29-12-2018</td>
                                    <td>$3,695</td>
                                </tr>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">#1</th>
                                    <td><img src="assets/backend/images/ecommerce/product_01.svg" class="img-fluid" width="35" alt="product"></td>
                                    <td>Apple MacBook Pro</td>
                                    <td>10,598</td>
                                </tr>
                                <tr>
                                    <th scope="row">#2</th>
                                    <td><img src="assets/backend/images/ecommerce/product_02.svg" class="img-fluid" width="35" alt="product"></td>
                                    <td>Dell Alienware</td>
                                    <td>8,986</td>
                                </tr>
                                <tr>
                                    <th scope="row">#3</th>
                                    <td><img src="assets/backend/images/ecommerce/product_03.svg" class="img-fluid" width="35" alt="product"></td>
                                    <td>Acer Predator Helios</td>
                                    <td>5,987</td>
                                </tr>
                                <tr>
                                    <th scope="row">#4</th>
                                    <td><img src="assets/backend/images/ecommerce/product_04.svg" class="img-fluid" width="35" alt="product"></td>
