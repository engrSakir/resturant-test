                            ...
                            <div class="row">
                                <div class="col-12 col-md-7 col-lg-7">
                                    <div class="invoice-logo">
                                        <img src="assets/backend/images/logo.svg" class="img-fluid" alt="invoice-logo">
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    <div class="invoice-meta-box text-right">
                                        ...
                                        <img src="assets/backend/images/general/signature.svg" class="img-fluid my-3" alt="signature">
