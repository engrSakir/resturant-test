                        ...
                        <div class="gallery-item-box">
                            <div class="grid row justify-content-md-center">
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 watch">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-1.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                ...
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 phone">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-2.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                        <div class="gallery-content">
                                            <p>Phone</p>
                                ...
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 tablet">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-3.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                        <div class="gallery-content">
                                            <p>Tablet</p>
                                ...
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 laptop">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-4.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                        <div class="gallery-content">
                                            <p>Laptop</p>
                                ...
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 accesories">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-5.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                        <div class="gallery-content">
                                            <p>Accesories</p>
                                ...
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 watch">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-6.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                        <div class="gallery-content">
                                            <p>Watch</p>
                                ...
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 phone">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-7.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                        <div class="gallery-content">
                                            <p>Phone</p>
                                ...
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 tablet">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-8.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                        <div class="gallery-content">
                                            <p>Tablet</p>
                                ...
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 laptop">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-9.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                        <div class="gallery-content">
                                            <p>Laptop</p>
                                ...
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 accesories">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-10.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                        <div class="gallery-content">
                                            <p>Accesories</p>
                                ...
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 phone">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-11.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                        <div class="gallery-content">
                                            <p>Phone</p>
                                ...
                                <div class="grid-item col-sm-6 col-md-6 col-lg-4 col-xl-3 accesories">
                                    <div class="gallery-box">
                                        <div class="gallery-preview">
                                            <img src="assets/backend/images/gallery/gallery-12.jpg" class="img-fluid" alt="gallery image"/>
                                        </div>
                                        <div class="gallery-content">
                                            <p>Accesories</p>
