                ...
                <div class="card-body">
                    <div class="table-responsive dash-flag-icon">
                        <table class="table table-borderless mb-2">
                            ...
                            <tbody>
                              <tr>
                                <th scope="row"><img src="assets/backend/images/browser/chrome.png" class="img-fluid" alt="chrome"></th>
                                <td>Google Chrome</td>
                                <td>35%</td>
                              </tr>
                              <tr>
                                <th scope="row"><img src="assets/backend/images/browser/safari.png" class="img-fluid" alt="safari"></th>
                                <td>Safari</td>
                                <td>30%</td>
                              </tr>
                              <tr>
                                <th scope="row"><img src="assets/backend/images/browser/windows.png" class="img-fluid" alt="windows"></th>
                                <td>Microsoft Edge</td>
                                <td>20%</td>
                              </tr>
                              <tr>
                                <th scope="row"><img src="assets/backend/images/browser/mozilla.png" class="img-fluid" alt="mozilla"></th>
                                <td>Mozilla Firefox</td>
                                <td>10%</td>
                              </tr>
                              <tr>
                                <th scope="row"><img src="assets/backend/images/browser/opera.png" class="img-fluid" alt="opera"></th>
                                <td>Opera</td>
                                <td>5%</td>
                              </tr>
                            </tbody>
