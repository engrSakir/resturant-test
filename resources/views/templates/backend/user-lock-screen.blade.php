                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="auth-box-icon">
                                        <img src="assets/backend/images/authentication/auth-box-icon-lock.svg" class="img-fluid" alt="auth-box-icon">
                                    </div>
                                    <div class="auth-box-logo">
                                        <img src="assets/backend/images/logo.svg" class="img-fluid " alt="logo">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <form action="#">
                                        ...
                                        <div class="user-logo mb-4">
                                            <img src="assets/backend/images/users/boy.svg" class="rounded-circle img-fluid" alt="user-img">
                                        </div>
