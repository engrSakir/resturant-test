                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">
                            <div class="profilebox py-4 text-center">
                                <img src="assets/backend/images/users/profile.svg" class="img-fluid" alt="profile">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-sm-6 col-md-6 col-lg-4">
                                    <img src="assets/backend/images/ecommerce/wallet.svg" class="img-fluid" alt="wallet">
                                </div>
                            </div>
