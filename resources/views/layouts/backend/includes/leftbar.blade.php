    ...
    <ul class="sidebar-menu do-nicescrol">
        ...
        <li>
            ...
            <ul class="sidebar-submenu">
                ...
                <li><a href="components-vertical-timeline.html"><i class="fa fa-circle-o"></i> Vertical Timeline</a>
                </li>
                <li><a href="components-horizontal-timeline.html"><i class="fa fa-circle-o"></i> Horizontal Timeline</a>
                </li>
        ...
        <li>
            ...
            <ul class="sidebar-submenu">
                ...
                <li><a href="form-horizontal-layouts.html"><i class="fa fa-circle-o"></i> Form Horizontal</a></li>
                <li><a href="form-striped-layouts.html"><i class="fa fa-circle-o"></i> Form Striped</a></li>
                <li><a href="form-hidden-label-ayouts.html"><i class="fa fa-circle-o"></i> Form Hidden Label</a></li>
        ...
        <li>
            ...
            <ul class="sidebar-submenu">
                ...
                <li><a href="table-striped-color-tables.html"><i class="fa fa-circle-o"></i> Striped Color Tables</a>
                </li>
        ...
        <li>
            ...
            <ul class="sidebar-submenu">
                ...
                <li><a href="authentication-reset-password.html"><i class="fa fa-circle-o"></i> Reset Password 1</a>
                </li>
                <li><a href="authentication-reset-password2.html"><i class="fa fa-circle-o"></i> Reset Password 2</a>
                </li>
            </ul>
        </li>
