                ...
                <div class="card m-b-30">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-5">
                                <ul class="list-inline-group text-right mb-0 pl-0">
                                    <li class="list-inline-item mr-0"><a href="#" class="card-arrow"><i
                                                class="feather icon-chevron-left"></i></a></li>
                                    <li class="list-inline-item"><a href="#" class="card-arrow"><i
                                                class="feather icon-chevron-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="card-body text-center pb-0 px-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4">
                                <p><span class="badge badge-success-inverse font-16">10%<i
                                            class="feather icon-arrow-up-right"></i></span></p>
                            </div>
                        </div>
                ...
                <div class="card m-b-30">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <ul class="list-inline-group text-right mb-0 pl-0">
                                    ...
                                    <li class="list-inline-item"><input type="checkbox" class="js-switch-performance"
                                            checked /></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="card-body text-center pb-0 px-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4">
                                <p><span class="badge badge-danger-inverse font-16">25%<i
                                            class="feather icon-arrow-down-right"></i></span></p>
                            </div>
                        </div>
                ...
                <div class="card m-b-30">
                                    ...
                                    <ul class="nav nav-pills mb-0" id="stastic-pills-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="pills-home-tab" data-toggle="pill"
                                                href="#pills-home" role="tab" aria-selected="true">Day</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-contact-tab" data-toggle="pill"
                                                href="#pills-contact" role="tab" aria-selected="false">Month</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="card-body text-center pb-0 px-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4">
                                <p><span class="badge badge-success-inverse font-16">19%<i
                                            class="feather icon-arrow-up-right"></i></span></p>
                            </div>
                        </div>
                ...
                <div class="card m-b-30">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <ul class="list-inline-group text-right mb-0 pl-0">
                                    <li class="list-inline-item mr-0 font-12">Update <a href="#"><i
                                                class="feather icon-refresh-cw font-16 text-primary ml-1"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="progress mb-2" style="height: 5px;">
                            <div class="progress-bar" role="progressbar" style="width: 70%;" aria-valuenow="40"
                ...
                <div class="card m-b-30">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4">
                                <ul class="list-inline-group text-right mb-0 pl-0">
                                    <li class="list-inline-item mr-0 font-12"><button type="button"
                                            class="btn btn-sm btn-primary-rgba font-14 px-2">Export</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4">
                                <ul class="list-inline-group text-right mb-0 pl-0">
                                    <li class="list-inline-item mr-0 font-12"><button type="button"
                                            class="btn btn-sm btn-success-rgba font-14 px-2">Update</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive dash-flag-icon">
                            <table class="table table-borderless mb-2">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><img src="assets/backend/images/browser/chrome.png"
                                                class="img-fluid" alt="chrome"></th>
                                        <td>Google Chrome</td>
                                        <td>35%</td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><img src="assets/backend/images/browser/safari.png"
                                                class="img-fluid" alt="safari"></th>
                                        <td>Safari</td>
                                        <td>30%</td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><img src="assets/backend/images/browser/windows.png"
                                                class="img-fluid" alt="windows"></th>
                                        <td>Microsoft Edge</td>
                                        <td>20%</td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><img src="assets/backend/images/browser/mozilla.png"
                                                class="img-fluid" alt="mozilla"></th>
                                        <td>Mozilla Firefox</td>
                                        <td>10%</td>
                                    </tr>
                                    <tr>
                                        <th scope="row"><img src="assets/backend/images/browser/opera.png" class="img-fluid"
                                                alt="opera"></th>
                                        <td>Opera</td>
                                        <td>5%</td>
                                    </tr>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-borderless mb-2">
                                <tbody>
                                    <tr>
                                        <td><img src="assets/backend/images/users/girl.svg" width="35" alt="girl"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="assets/backend/images/users/men.svg" width="35" alt="men"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td><img src="assets/backend/images/users/boy.svg" width="35" alt="boy"></td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <div class="progress mt-2" style="height: 5px;">
                                                <div class="progress-bar bg-success" role="progressbar" style="width: 49%;"
                                    ...
                                    <tr>
                                        <td><img src="assets/backend/images/users/women.svg" width="35" alt="women"></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="progress mt-2" style="height: 5px;">
                                                <div class="progress-bar bg-warning" role="progressbar" style="width: 41%;"
                                ...
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <p class="piety-data-attributes mb-0 mr-3">
                                            <span
                                                data-peity='{ "fill": ["#944dff", "#e9eff9"],   "innerRadius": 20, "radius": 24 }'>5/7</span>
                                        </p>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <p class="piety-data-attributes mb-0 mr-3">
                                            <span
                                                data-peity='{ "fill": ["#08d26f", "#e9eff9"],   "innerRadius": 20, "radius": 24 }'>5.5/7</span>
                                        </p>
                                        <div class="media-body">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <p class="piety-data-attributes mb-0 mr-3">
                                            <span
                                                data-peity='{ "fill": ["#ffe411", "#e9eff9"],   "innerRadius": 20, "radius": 24 }'>4/7</span>
                                        </p>
                                        <div class="media-body">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <p class="piety-data-attributes mb-0 mr-3">
                                            <span
                                                data-peity='{ "fill": ["#fc4f68", "#e9eff9"],   "innerRadius": 20, "radius": 24 }'>3/7</span>
                                        </p>
                                        <div class="media-body">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <p class="piety-data-attributes mb-0 mr-3">
                                            <span
                                                data-peity='{ "fill": ["#81cef6", "#e9eff9"],   "innerRadius": 20, "radius": 24 }'>6.5/7</span>
                                        </p>
                                        <div class="media-body">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <p class="piety-data-attributes mb-0 mr-3">
                                            <span
                                                data-peity='{ "fill": ["#bcc4dc", "#e9eff9"],   "innerRadius": 20, "radius": 24 }'>2/7</span>
                                        </p>
                                        <div class="media-body">
