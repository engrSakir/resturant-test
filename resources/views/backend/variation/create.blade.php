    ...
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title">Variation create</h4>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{ route('variation.index') }}" class="btn btn-primary">Back to list</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="card m-b-30 col-12 ">
                <div class="card-header bg-danger">
                    <h5 class="card-title">Variation create</h5>
                </div>
                <div class="card-body">
                    <form class="row justify-content-center" method="POST" action="{{ route('variation.store') }}"
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="form-group row">
                                <label for="category" class="col-sm-4 col-form-label">Variation Category</label>
                                <div class="col-sm-8">
                                    <select name="category" class="select2-single form-control">
                                        <option value="">Select</option>
                                        @foreach ($variation_categoeies as $variation_category)
                                            <option @if ($category_id == $variation_category->id) selected class="bg-success" @endif
                                                value="{{ $variation_category->id }}">{{ $variation_category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('variationCreateBasedOnCategory', $category_id) !!}',
                columns: [{
                        data: 'name',
                        name: 'name'
                    },
