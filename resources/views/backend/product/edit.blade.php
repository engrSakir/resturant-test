        ...
        <div class="row">
            <div class="card m-b-30 col-12 ">
                <div class="card-header bg-danger">
                    ...
                    <a class="btn btn-info float-right productCategoryBtn" href="javascript:0">Product Categoty</a>
                </div>
                <div class="card-body">
                    <form class="row justify-content-center" method="POST" action="{{ route('product.update', $product) }}"
                        ...
                        <div class="col-lg-10">
                                ...
                                <div class="col-sm-8">
                                    <select name="category" class="select2-single form-control">
                                        ...
                                        @foreach ($product_categories as $product_category)
                                            <option @if ($product->category_id == $product_category->id) selected @endif
                            ...
                            <div class="form-group row">
                                <img class="rounded-circle" height="70px;" width="70px;"; src="{{ asset($product->image ?? get_static_option('no_image')) }}" alt="">
                        ...
                        <tfoot>
                            @foreach ($product_categories as $product_category)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('productCategory.edit', $product_category) }}" class="btn btn-info"><i class="fa fa-edit"></i> </a> <button class="btn btn-danger" onclick="delete_function(this)"
