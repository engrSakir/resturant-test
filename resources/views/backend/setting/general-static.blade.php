                    ...
                    <form class="row" method="POST" action="{{  route('generalStaticUpdate') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control-lg website_meta_description" name="website_meta_description" id="website_meta_description" cols="30" rows="10">{{ get_static_option('website_meta_description') }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
