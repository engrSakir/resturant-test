    ...
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title">Custom page edit</h4>
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Custom page edit</li>
                    </ol>
                </div>
            </div>
    ...
    <div class="contentbar">
        ...
        <div class="row">
            <div class="card m-b-30 col-12 ">
                ...
                <div class="card-body">
                    <form class="row justify-content-center" method="POST" action="{{  route('customPage.update', $customPage) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="col-12">
