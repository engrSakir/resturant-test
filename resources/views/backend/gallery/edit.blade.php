    ...
    <div class="breadcrumbbar">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 col-lg-4">
                <div class="widgetbar">
                    <a href="{{ route('gallery.index') }}" class="btn btn-primary">Back to list</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="contentbar">
        ...
        <div class="row">
            <div class="card m-b-30 col-12 ">
                ...
                <div class="card-body">
                    <form class="row justify-content-center" method="POST" action="{{ route('gallery.update', $gallery) }}"
                        ...
                        <div class="col-lg-10">
                            <div class="form-group row">
                                ...
                                <img height="70px;" width="70px;" class="rounded-cercle" src="{{ asset($gallery->image ?? get_static_option('no_image')) }}" alt="">
                                <div class="col-sm-8">
